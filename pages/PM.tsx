  ...
  return (
    <div className="flex flex-col w-full bg-primary text-secondary-gray font-body">
      <section className="py-20 px-4 max-w-5xl mx-auto w-full text-center">
        ...
        <p className="text-xl text-secondary-gray max-w-2xl mx-auto mb-12">
          Watch the breakdown below to see exactly how we save property managers 20+ hours a week and capture 100% of leasing leads.
        </p>
